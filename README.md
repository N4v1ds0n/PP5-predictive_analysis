...
|**Confusion matrix for model was off compared to performance statistics**|Wrote 'collect predictions' function that stores predictions in a list to avoid errors|
